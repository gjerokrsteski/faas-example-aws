...
aws cloudformation deploy --region eu-west-1 --template-file ./packaged.yaml --stack-name sac2019-csharp-${aws_stage} --parameter-overrides Stage=${aws_stage} --capabilities CAPABILITY_IAM
